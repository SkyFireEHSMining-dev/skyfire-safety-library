(function () {
  ...
  const manifest = {
    "§3": { usc:"30 U.S.C. §802", url:"https://uscode.house.gov/view.xhtml?edition=prelim&num=0&req=granuleid%3AUSC-prelim-title30-section802", files:["802-1.txt","802-2.txt","802-3.txt"] },
    "§103": { usc:"30 U.S.C. §813", url:"https://uscode.house.gov/view.xhtml?edition=prelim&num=0&req=granuleid%3AUSC-prelim-title30-section813", files:["813-1.txt","813-2.txt","813-3.txt","813-4.txt","813-5.txt","813-6.txt"], notes:[`The codified source contains the spelling "repersentative" in subsection (g)(1); the U.S. Code editorial note states that it probably should be "representative." SkyFire preserves the source wording.`] },
    "§104": { usc:"30 U.S.C. §814", url:"https://uscode.house.gov/view.xhtml?edition=prelim&num=0&req=granuleid%3AUSC-prelim-title30-section814", files:["814-1.txt","814-2.txt","814-3.txt","814-4.txt","814-5.txt"] },
    "§105": { usc:"30 U.S.C. §815", url:"https://uscode.house.gov/view.xhtml?edition=prelim&num=0&req=granuleid%3AUSC-prelim-title30-section815", files:["815-1.txt","815-2.txt","815-3.txt","815-4.txt","815-5.txt","815-6.txt"], notes:[`30 U.S.C. §815(c)(2) reads "his paragraph" in the codified source; the U.S. Code editorial note states that it probably should be "this." SkyFire preserves the source wording.`] },
    "§107": { usc:"30 U.S.C. §817", url:"https://uscode.house.gov/view.xhtml?edition=prelim&num=0&req=granuleid%3AUSC-prelim-title30-section817", files:["817-1.txt","817-2.txt","817-3.txt"] },
    "§110": { usc:"30 U.S.C. §820", url:"https://uscode.house.gov/view.xhtml?edition=prelim&num=0&req=granuleid%3AUSC-prelim-title30-section820", files:["820-1.txt","820-2.txt","820-3.txt","820-4.txt","820-5.txt"], notes:[`30 U.S.C. §820(b)(1) displays "$$5,000" in the codified source and marks it "So in original." SkyFire preserves that source text.`], penalty:`Statutory dollar figures shown here are the codified statutory text, not a current penalty calculator. For a live penalty amount, verify current 30 CFR Part 100 and current federal civil-penalty adjustments.` }
  };
