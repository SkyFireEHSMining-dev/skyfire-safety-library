...
function initialize5STool() {
    ...
    <div class="five-s-guide-wrap">
      ...
      <details class="info-panel five-s-stage" data-stage="Sort">
        ...
        <div class="five-s-detail-body">
          ...
          <h4>Field actions</h4>
          <ul><li>Identify items that are unnecessary, obsolete, damaged, duplicated, or no longer used.</li><li>Remove, dispose of, return, relocate, or quarantine those items through the appropriate site process.</li><li>Keep only the tools, materials, supplies, and information needed in or near the work area.</li></ul>
          <h4>Ask</h4>
      ...
      <details class="info-panel five-s-stage" data-stage="Set in Order">
        ...
        <div class="five-s-detail-body">
          ...
          <h4>Field actions</h4>
          <ul><li>Locate frequently used items where they are easy to reach and return.</li><li>Use defined storage locations, labels, outlines, racks, bins, or other visual controls where useful.</li><li>Arrange the area around the actual work flow rather than simply making it look neat.</li><li>Keep access routes, work zones, controls, and emergency equipment clear as required by the site.</li></ul>
          <h4>Ask</h4>
      ...
      <details class="info-panel five-s-stage" data-stage="Sustain">
        ...
        <div class="five-s-detail-body">
          ...
          <h4>Field actions</h4>
          <ul><li>Build ownership into routine work rather than relying on occasional cleanup campaigns.</li><li>Use short checks, coaching, visual confirmation, or periodic review to recognize drift.</li><li>Correct the reason the standard is difficult to maintain instead of repeatedly blaming the user.</li><li>Update the standard when the work, equipment, or process changes.</li></ul>
          <h4>Ask</h4>
  ...
  tile.addEventListener("click", () => {
    document.querySelectorAll(".app-section").forEach(appSection => appSection.classList.add("hidden"));
