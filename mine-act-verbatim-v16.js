(function () {
  ...
  const manifest = {
    ...
    "§110": { usc:"30 U.S.C. §820", url:"https://uscode.house.gov/view.xhtml?edition=prelim&num=0&req=granuleid%3AUSC-prelim-title30-section820", files:["820.txt"], notes:[`30 U.S.C. §820(b)(1) displays "$$5,000" in the codified source and marks it "So in original." SkyFire preserves the statutory wording.`], penalty:`Statutory dollar figures shown here are the codified statutory text, not a current penalty calculator. For a live penalty amount, verify current 30 CFR Part 100 and current federal civil-penalty adjustments.` }
  };
